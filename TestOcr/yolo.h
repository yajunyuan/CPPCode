...
public:
	...
	void Detect(cv::Mat& SrcImg, cv::dnn::Net& net, int& outputResultLen, RecResult*& outputResult);
...
private:
	...
	const int _netWidth = 128;   //ONNX图片输入宽度
	const int _netHeight = 128;  //ONNX图片输入高度
#endif // YOLO_P6
